...
from graphiti_core.llm_client.openai_client import OpenAIClient, LLMConfig, AsyncOpenAI  # 自定义LLM
...
neo4j_password = os.environ.get('NEO4J_PASSWORD', 'Lch040227.')
...
async def main():
    ...
    api_key = 'sk-Ud7jXfgBxJhIgKCvAbA1AaAb778f4c54838eA3FeD527458d'
    base_url = 'https://api.rcouyi.com/v1/'

    # Initialize Graphiti with rcouyi clients
    graphiti = Graphiti(
        neo4j_uri,
        neo4j_user,
        neo4j_password,
    ...
    try:
        ...
        info = 'Who was the California Attorney General?'
        print(f"\nSearching for: '{info}'")
        results = await graphiti.search(f'{info}')
        ...
        if results and len(results) > 0:
            ...
            reranked_results = await graphiti.search(
                f'{info}', center_node_uuid=center_node_uuid
            )
